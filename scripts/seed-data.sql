-- Seed initial data for the marketplace
...
('Jane Smith', 'jane@personal.com', '$2b$10$hash', 'personal', NULL, 0, 0, 'active'),
('Bob Wilson', 'bob@business.com', '$2b$10$hash', 'business', 'Wilson Industries', 10000, 3500, 'active'),
('Alice Johnson', 'alice@company.com', '$2b$10$hash', 'business', 'Johnson LLC', 7500, 2100, 'active');
...
('ORD-002', 3, 45.50, 'credit_card', 'shipped', '456 Home Ave, City, State 12345', '456 Home Ave, City, State 12345'),
('ORD-003', 4, 299.99, 'credit_line', 'delivered', '789 Corporate Blvd, City, State 12345', '789 Corporate Blvd, City, State 12345'),
('ORD-004', 5, 89.99, 'credit_card', 'processing', '321 Office Park, City, State 12345', '321 Office Park, City, State 12345');
